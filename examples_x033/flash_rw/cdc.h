...
typedef struct {
	...
	volatile uint8_t rxing; //to się ustawia na 0 gdy endpointa 3 przyszedł IN request, oraz gdy nie jest zerem i nastąpił timeout na otrzymanie requestu IN
	...
	uint32_t txing; // Number of bytes currently in transmission to UART
